...
<Layout title="Clientes">
    ...
    <svelte:fragment slot="additional">
        <form on:submit|preventDefault={id ? update : store}>
            <Modal title={id ? "Actualizar cliente" : "Novo cliente"}>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input
                        ...
                        type="text"
                        id="site"
                        class:is-invalid={$form.errors.site}
                        class="form-control"
                        placeholder="Site"
                        required
                    />
                ...
                <svelte:fragment slot="additionalActions">
                    ...
                    {:else}
                        <a href={$form.site} class="btn" target="_blank">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
